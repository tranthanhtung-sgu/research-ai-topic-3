...
def main_orchestrator():
    # --- CASE Condition (e.g., LBBB from validation06.npy) ---
    case_npy_file_path = "../validation/validation06/validation06.npy"
    case_condition_label_short = "LBBB" # For file prefix
    case_condition_label_full = "LBBB CASE" # For titles/reports
    ...
    if case_condition_label_short == "LBBB":
        report_lines.append("Key LBBB indicators to check (Compare CASE vs REFERENCE in plots):")
