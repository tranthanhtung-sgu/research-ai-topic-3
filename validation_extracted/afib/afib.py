...
def main_orchestrator():
    # --- CASE Condition (e.g., AFib from validation04.npy) ---
    case_npy_file_path = "../validation/validation04/validation04.npy"
    ...
    if case_condition_label_short == "AFIB":
        ...
        report_lines.append("  - QRS Duration: Usually normal unless BBB.")
