...
def main_orchestrator():
    # --- CASE Condition (e.g., NORM from validation06.npy) ---
    case_npy_file_path = "../validation/validation06/validation01.npy"
    case_condition_label_short = "NORM" # For file prefix
    case_condition_label_full = "NORM CASE" # For titles/reports
    ...
    if case_condition_label_short == "NORM":
        report_lines.append("Key NORM indicators to check (Compare CASE vs REFERENCE in plots):")
        report_lines.append("  - QRS Duration: Prolonged (>120ms) with characteristic morphology")
        report_lines.append("  - QRS Morphology: Broad monophasic R waves in I, aVL, V5-V6; deep S waves in V1-V3")
        report_lines.append("  - ST-T Changes: Secondary repolarization abnormalities")
        report_lines.append("  - Axis: Usually left axis deviation")
